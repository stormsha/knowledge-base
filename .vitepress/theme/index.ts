...
export default {
  ...
  Layout: () => {
    ...
    return h(DefaultTheme.Layout, props, {
      ...
      // 为较宽的屏幕的导航栏添加阅读增强菜单
      'nav-bar-content-after': () => h(NavBarContentAfter, {
        links: [
          {platform: "微信", icon: "/social/wechat.svg", qrCode: "/social/wechat-qrcode.png"},
          {platform: "公众号", icon: "/social/gzh.svg", qrCode: "/social/gzh-qrcode.png"},
        ],
      }),
